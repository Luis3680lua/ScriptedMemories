...
local ShopMus = Sounds:WaitForChild("mus", 10) and Sounds:WaitForChild("mus", 10):WaitForChild("Menu", 10) and Sounds:WaitForChild("mus", 10):WaitForChild("Menu", 10):WaitForChild("ShopMus", 10)
if not ShopMus then return end
local MusicGroup = Sounds:WaitForChild("musg", 10)

local DATOS_CANCIONES = {
    { Url = "https://raw.githubusercontent.com/Luis3680lua/ScriptedMemories/main/Shop/Music/Lone.mp3", Archivo = folderName .. "/Lone.mp3", Creditos = "Lone by ThatGuyRamon" },
    { Url = "https://raw.githubusercontent.com/Luis3680lua/ScriptedMemories/main/Shop/Music/OfAnotherDreamv2.mp3", Archivo = folderName .. "/OfAnotherDreamv2.mp3", Creditos = "Of Another Dream v2 by Juno!" },
    { Url = "https://raw.githubusercontent.com/Luis3680lua/ScriptedMemories/main/Shop/Music/OnceUponRemix.mp3", Archivo = folderName .. "/OnceUponRemix.mp3", Creditos = "Once Upon (Remix) by Astranova" },
    { Url = "https://raw.githubusercontent.com/Luis3680lua/ScriptedMemories/main/Shop/Music/InvoluntariaScore.mp3", Archivo = folderName .. "/InvoluntariaScore.mp3", Creditos = "Involuntaria Score (Unfinished) by Juno!" },
    { Url = "https://raw.githubusercontent.com/Luis3680lua/ScriptedMemories/main/Shop/Music/LostAndFound.mp3", Archivo = folderName .. "/LostAndFound.mp3", Creditos = "Lost & Found (Unfinished) by Juno!" },
...
local function corregirCreditosOriginales(nombreBusqueda, nuevosCreditos)
    ...
    for _, sonido in ipairs(ShopMus:GetChildren()) do
        if sonido:IsA("Sound") then
            ...
            if (titulo:find(buscar, 1, true) or nombre:find(buscar, 1, true)) and not titulo:find("v2", 1, true) then
