...
createLabel(sectionFrame, "📶 Ping y FPS", T.FontBold, 15, T.Accent, 22)
...
createLabel(textFrame, "Activar medidor avanzado de FPS/Ping", T.FontBold, 14, T.Text, 18)
createLabel(textFrame, "Muestra FPS y ping en tiempo real", T.Font, 11, T.TextDim, 14)
...
createLabel(positionSection, "📍 Posición", T.FontBold, 14, T.Text, 22)
...
createLabel(customXRow, "Offset X", T.Font, 13, T.TextDim, 22).Size = UDim2.new(0, 80, 0, 22)
...
createLabel(customYRow, "Offset Y", T.Font, 13, T.TextDim, 22).Size = UDim2.new(0, 80, 0, 22)
