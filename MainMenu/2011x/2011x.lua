local CONFIG = {
    Name = "Ejemplo de ajuste para 2011x",
    Description = "Esto es una plantilla de ejemplo. Reemplaza esto por las opciones reales de 2011x.",
    SettingKey = "char_2011x_example",
    Default = false
}
...
if Menu.CharacterUI.RegisterCleanup then
    Menu.CharacterUI:RegisterCleanup(function() end)
end
