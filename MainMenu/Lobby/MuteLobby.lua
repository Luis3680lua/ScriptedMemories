...
local function createRow(id, data, isSpecial)
    ...
    info.Size = UDim2.new(1, -100, 0, 28)
    info.Position = UDim2.new(0, 32, 0, 0)
    ...
    indicator.Position = UDim2.new(1, -6, 0, 2)
